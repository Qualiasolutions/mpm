    ...
    <div className="space-y-8">
      <div className="flex flex-col items-center text-center space-y-6">
        <div className="flex flex-col items-center mb-2">
          <h1 className="text-6xl font-black text-slate-900 tracking-tighter leading-none mb-1 relative">
      ...
      <div className="rounded-2xl border-0 shadow-xl shadow-slate-200/60 bg-white/80 backdrop-blur-sm p-8">
